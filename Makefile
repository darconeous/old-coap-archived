...
SMCP_SOURCE_FILES=smcp.c smcp_list.c smcp_send.c smcp_node.c smcp_pairing.c btree.c url-helpers.c coap.c smcp_timer.c smcp_timer_node.c smcp_variable_node.c
