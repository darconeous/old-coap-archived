...
**
**	`src/examples/example-1.c`
**
**	This example shows how to respond to a request.
**
...
request_handler(void* context) {
	/* This will respond to every GET request with "Hello world!". */
...
int
main(void) {
	smcp_t instance = smcp_create(COAP_DEFAULT_PORT);
